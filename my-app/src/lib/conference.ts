...
export const schedules: ConferenceSchedule = {
  day1: {
    ...
    events: [
      { time: "19:00", title: "Welcome & Transportation to Conference", location: "Airports" },
  ...
  day2: {
    ...
    events: [
      ...
      { time: "12:45", title: "Lunch Break", location: "Kaeng Krachan National Park" },
      { time: "15:00", title: "Transportation Back to Amphawa", location: "Kaeng Krachan National Park" },
      { time: "17:00", title: "Explore Amphawa Water Market", location: "Amphawa Water Market" },
      { time: "20:00", title: "Transportation Back to Conference", location: "Amphawa Water Market" },
      { time: "21:00", title: "Break Time", location: "The Grace Amphawa" },
      { time: "22:00", title: "Evening Curfew", location: "The Grace Amphawa" },
    ],
  },
  day3: {
    ...
    events: [
      ...
      { time: "11:30", title: "Lunch Break", location: "Dining Hall" },
      { time: "12:30", title: "Stories Time", location: "Various Rooms" },
      { time: "13:30", title: "Break Time", location: "Various Rooms" },
      { time: "13:45", title: "Workshop #1", location: "Various Rooms" },
      { time: "15:15", title: "Workshop #2", location: "Dining Hall" },
      { time: "16:45", title: "Break Time", location: "Assembly Hall" },
      { time: "18:00", title: "Dinner", location: "The Grace Amphawa" },
      { time: "19:00", title: "Session #2", location: "Assembly Hall" },
      { time: "21:30", title: "Fellowship Time", location: "Assembly Hall" },
  ...
  day4: {
    ...
    events: [
      { time: "08:00", title: "Breakfast & Check-out", location: "Dining Hall" },
      { time: "09:00", title: "Session #3 | Sunday Service", location: "Assembly Hall" },
      { time: "12:00", title: "Lunch Break", location: "Dining Hall" },
      { time: "13:00", title: "Workshop #3", location: "Assembly Hall" },
      { time: "14:00", title: "Conference Finale", location: "Assembly Hall" },
      { time: "15:00", title: "Transportation to Dinner and Airports", location: "The Grace Amphawa" },
    ],
  },
};
